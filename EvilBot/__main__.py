...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`Hello` [👿](https://telegra.ph/file/b1ae67fad00c60d51a5f2.jpg) `My name is` *Earthdefi Bot*
`I'm here to help you manage your groups! Hit` *📚commands*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="Add me to your place😇", url="t.me/Earthdefi_bot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="About💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="My web🌐", url=f"http://evilbotz.art.blog"
        ),
     ],
     [  
        InlineKeyboardButton(text="Support🛠", url="https://t.me/EVIL_SUPPORT_CHAT"),
        InlineKeyboardButton(text="Repo🇮🇳", url="https://github.com/shrvan42/EvilBot"),
    ], 
...
HELP_STRINGS = """
`Hey!.. I'm` 👿 *Eartdefi bot* [👿](https://telegra.ph/file/a064bd8497a5f6f03b290.mp4)
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @earthdefi \
